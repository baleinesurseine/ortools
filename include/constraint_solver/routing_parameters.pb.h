...
enum RoutingModelParameters_TrailCompression {
  RoutingModelParameters_TrailCompression_NONE = 0,
  RoutingModelParameters_TrailCompression_ZLIB = 1,
  RoutingModelParameters_TrailCompression_RoutingModelParameters_TrailCompression_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  RoutingModelParameters_TrailCompression_RoutingModelParameters_TrailCompression_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool RoutingModelParameters_TrailCompression_IsValid(int value);
const RoutingModelParameters_TrailCompression RoutingModelParameters_TrailCompression_TrailCompression_MIN = RoutingModelParameters_TrailCompression_NONE;
const RoutingModelParameters_TrailCompression RoutingModelParameters_TrailCompression_TrailCompression_MAX = RoutingModelParameters_TrailCompression_ZLIB;
const int RoutingModelParameters_TrailCompression_TrailCompression_ARRAYSIZE = RoutingModelParameters_TrailCompression_TrailCompression_MAX + 1;

const ::google::protobuf::EnumDescriptor* RoutingModelParameters_TrailCompression_descriptor();
inline const ::std::string& RoutingModelParameters_TrailCompression_Name(RoutingModelParameters_TrailCompression value) {
  return ::google::protobuf::internal::NameOfEnum(
    RoutingModelParameters_TrailCompression_descriptor(), value);
}
inline bool RoutingModelParameters_TrailCompression_Parse(
    const ::std::string& name, RoutingModelParameters_TrailCompression* value) {
  return ::google::protobuf::internal::ParseNamedEnum<RoutingModelParameters_TrailCompression>(
    RoutingModelParameters_TrailCompression_descriptor(), name, value);
}
// ===================================================================
...
class RoutingModelParameters : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.RoutingModelParameters) */ {
 public:
  ...
  typedef RoutingModelParameters_TrailCompression TrailCompression;
  static const TrailCompression NONE =
    RoutingModelParameters_TrailCompression_NONE;
  static const TrailCompression ZLIB =
    RoutingModelParameters_TrailCompression_ZLIB;
  static inline bool TrailCompression_IsValid(int value) {
    return RoutingModelParameters_TrailCompression_IsValid(value);
  }
  static const TrailCompression TrailCompression_MIN =
    RoutingModelParameters_TrailCompression_TrailCompression_MIN;
  static const TrailCompression TrailCompression_MAX =
    RoutingModelParameters_TrailCompression_TrailCompression_MAX;
  static const int TrailCompression_ARRAYSIZE =
    RoutingModelParameters_TrailCompression_TrailCompression_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  TrailCompression_descriptor() {
    return RoutingModelParameters_TrailCompression_descriptor();
  }
  static inline const ::std::string& TrailCompression_Name(TrailCompression value) {
    return RoutingModelParameters_TrailCompression_Name(value);
  }
  static inline bool TrailCompression_Parse(const ::std::string& name,
      TrailCompression* value) {
    return RoutingModelParameters_TrailCompression_Parse(name, value);
  }

  // accessors -------------------------------------------------------

  // optional bool reduce_vehicle_cost_model = 1;
  void clear_reduce_vehicle_cost_model();
  static const int kReduceVehicleCostModelFieldNumber = 1;
  bool reduce_vehicle_cost_model() const;
  void set_reduce_vehicle_cost_model(bool value);

  // optional .operations_research.RoutingModelParameters.TrailCompression trail_compression = 2;
  void clear_trail_compression();
  static const int kTrailCompressionFieldNumber = 2;
  ::operations_research::RoutingModelParameters_TrailCompression trail_compression() const;
  void set_trail_compression(::operations_research::RoutingModelParameters_TrailCompression value);

  // optional .operations_research.ConstraintSolverParameters solver_parameters = 3;
  bool has_solver_parameters() const;
  void clear_solver_parameters();
  static const int kSolverParametersFieldNumber = 3;
...
// optional .operations_research.RoutingModelParameters.TrailCompression trail_compression = 2;
inline void RoutingModelParameters::clear_trail_compression() {
  trail_compression_ = 0;
}
inline ::operations_research::RoutingModelParameters_TrailCompression RoutingModelParameters::trail_compression() const {
  // @@protoc_insertion_point(field_get:operations_research.RoutingModelParameters.trail_compression)
  return static_cast< ::operations_research::RoutingModelParameters_TrailCompression >(trail_compression_);
}
inline void RoutingModelParameters::set_trail_compression(::operations_research::RoutingModelParameters_TrailCompression value) {
  
  trail_compression_ = value;
  // @@protoc_insertion_point(field_set:operations_research.RoutingModelParameters.trail_compression)
}
...
template <> struct is_proto_enum< ::operations_research::RoutingModelParameters_TrailCompression> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::operations_research::RoutingModelParameters_TrailCompression>() {
  return ::operations_research::RoutingModelParameters_TrailCompression_descriptor();
}
