...
$(OBJ_DIR)$Sedouard.$O: $(CPP_EX_DIR)$Sedouard.cc $(INC_DIR)$Sconstraint_solver$Sconstraint_solver.h
	$(CCC) $(CFLAGS) -c $(CPP_EX_DIR)$Sedouard.cc $(OBJ_OUT)$(OBJ_DIR)$Sedouard.$O

$(CPP_BIN_DIR)$Sedouard$E: $(OBJ_DIR)$Sedouard.$O
	$(CCC) $(CFLAGS) $(OBJ_DIR)$Sedouard.$O $(OR_TOOLS_LIBS) $(LD_FLAGS) $(EXE_OUT)$(CPP_BIN_DIR)$Sedouard$E
